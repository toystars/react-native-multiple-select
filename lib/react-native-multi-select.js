...
export default class MultiSelect extends Component {
  ...
  _addItem = item => {
    ...
    newItems = [...items, { id: item.name.replace(' ', '-'), name: item.name }];
    newSelectedItems = [...selectedItems, item.name.replace(' ', '-')];
  ...
  _renderItems = () => {
    ...
    if (renderItems.length) {
      ...
      component = this._getRowNew({ name: searchTerm });
    }
    return component;
  };
          ...
          <View style={styles.selectorView(fixedHeight)}>
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                blurOnSubmit={false}
                onSubmitEditing={this._addNewItemEnter}
